function createAndRenameSheets() {
  ...
  for (var i = 0; i < sheetsData.length; i++) {
    ...
    range.setFormula('=FILTER(Master!A:L, Master!C:C="' + filterValue + '")'); // Set rumus pada cell A1
    
    // Menyalin dan menempelkan data dari sel A1:L1 di sheet master ke setiap sheet baru
